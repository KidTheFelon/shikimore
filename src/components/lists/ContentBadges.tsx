...
export default function ContentBadges({ item, accentColor }: ContentBadgesProps) {
  ...
  return (
    <>
      ...
      {kind && (
        <div 
          className={styles.contentCardKind}
          style={accentColor && accentColor !== 'transparent' ? { background: accentColor } : undefined}
        >
          {kind}
        </div>
      )}
